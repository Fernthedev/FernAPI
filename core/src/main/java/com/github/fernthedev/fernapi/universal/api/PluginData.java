...
public interface PluginData<T> {
     ...
     *     behavior should not be relied on. {@link com.github.fernthedev.fernapi.universal.handlers.MethodInterface#getDataFolder()}
     ...
     * <ul>
     * <li>This includes all messages using {@link java.util.logging.Logger} ()}.
