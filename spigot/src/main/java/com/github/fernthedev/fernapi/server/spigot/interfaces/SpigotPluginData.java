...
public class SpigotPluginData implements PluginData<PluginDescriptionFile> {

    @NonNull
    private final PluginDescriptionFile spigotPluginData;
     ...
     */
    @Override
    public PluginDescriptionFile getPluginDataInstance() {
        return spigotPluginData;
    }
    ...
    public String getName() {
        return spigotPluginData.getName();
    }
    ...
    public String getVersion() {
        return spigotPluginData.getVersion();
    }
    ...
    public String getMain() {
        return spigotPluginData.getMain();
    }
    ...
    public String getDescription() {
        return spigotPluginData.getDescription();
    }
    ...
    @NotNull
    @Override
    public com.github.fernthedev.fernapi.universal.api.PluginLoadOrder getLoad() {
        return com.github.fernthedev.fernapi.universal.api.PluginLoadOrder.valueOf(spigotPluginData.getLoad().toString());
    }
    ...
    public List<String> getAuthors() {
        return spigotPluginData.getAuthors();
    }
    ...
    public String getWebsite() {
        return spigotPluginData.getWebsite();
    }
    ...
    public List<String> getDepend() {
        return spigotPluginData.getDepend();
    }
    ...
    public List<String> getLoadBefore() {
        return spigotPluginData.getLoadBefore();
    }
    ...
    public String getPrefix() {
        return spigotPluginData.getPrefix();
    }
}
