...
public class SpigotServerInfo implements Server, IServerInfo {
    ...
    private final InetSocketAddress address = new InetSocketAddress(server.getPort());
     ...
     */
    @Override
    public boolean dispatchCommand(@NotNull org.bukkit.command.CommandSender sender, @NotNull String commandLine) throws CommandException {
    ...
    @NotNull
    @Override
    public List<Entity> selectEntities(@NotNull org.bukkit.command.CommandSender sender, @NotNull String selector) throws IllegalArgumentException {
    ...
    public void sendData(String channel, byte[] data) {
        throw new IllegalStateException("Not applicable to Bukkit");
    }
