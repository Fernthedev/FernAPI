...
public class VelocityPluginData implements PluginData<PluginDescription> {

    @NonNull
    private FernVelocityAPI fernVelocityAPI;

    @NonNull
    private final PluginDescription velocityPluginData;
    ...
    public String getName() {
        return velocityPluginData.getId();
    }
    ...
    public String getVersion() {
        return velocityPluginData.getVersion().orElse("");
    }
    ...
    public String getMain() {
        return fernVelocityAPI.getClass().getName();
    }
    ...
    public String getDescription() {
        return velocityPluginData.getDescription().orElse("");
    }
    ...
    public List<String> getAuthors() {
        return velocityPluginData.getAuthors();
    }
    ...
    public String getWebsite() {
        return velocityPluginData.getUrl().orElse("");
    }
    ...
    public List<String> getDepend() {
        return velocityPluginData.getDependencies().parallelStream().map(PluginDependency::getId).collect(Collectors.toList());
    }
    ...
    public List<String> getSoftDepend() {
        return velocityPluginData.getDependencies().parallelStream().filter(PluginDependency::isOptional).map(PluginDependency::getId).collect(Collectors.toList());
    }
